...
public class clientrequest extends AppCompatActivity implements View.OnClickListener {
    ...
    public class ClientClass extends Thread{
        ...
        ClientClass(InetAddress address){
            ...
            Log.i("myApp",address.getHostAddress());
        }
    ...
    void checkLocationEnabled(){
        LocationManager lm = (LocationManager)clientrequest.this.getSystemService(Context.LOCATION_SERVICE);
        ...
        if(!gps_enabled && !network_enabled) {
            // notify user
            new AlertDialog.Builder(clientrequest.this)
                    .setTitle(R.string.gps_network_not_enabled_title)
                    .setMessage(R.string.gps_network_not_enabled)
                    .setPositiveButton(R.string.open_location_settings, new DialogInterface.OnClickListener() {
                        @Override
                        public void onClick(DialogInterface paramDialogInterface, int paramInt) {
                            clientrequest.this.startActivity(new Intent(Settings.ACTION_LOCATION_SOURCE_SETTINGS));
                        }
                    })
